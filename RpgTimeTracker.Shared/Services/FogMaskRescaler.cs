...
{
    /// <summary>Nearest-neighbor resample: maps each new-grid cell's CENTER (not corner) back to
    ...
    ///     keeps the resample unbiased regardless of the new/old cell-size ratio.</summary>
